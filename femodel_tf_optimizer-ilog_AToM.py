...
if __name__ == '__main__':
    ...
    reference_params = {}
    reference_params['ub'] = [ 0.0*beta, 40.0*beta ]
    reference_params['sb'] = [ 4.5*beta, 5.0*beta ]
    reference_params['pb'] = [ 1.0, 1.e-32 ]
    reference_params['elj'] = [ 10.0*beta, 10.0*beta ]
    reference_params['uce'] = [ 1.0, 20.0 ]
    reference_params['nl']  = [ 10.0, 10.0 ]
    reference_params['wg'] =  [ 1.0e-7, 1.0 ]
    
    scale_params = {}
    scale_params['ub'] =  [ 1.0* beta, 1.0*beta ]
    scale_params['sb'] =  [ 1.0*beta, 1.0*beta ]
    scale_params['pb'] =  [ 1.0, 1.e-32 ]
